data_to_upload = []  // replace [] with your data
...
console.log("All trees have been entered even though you see no markers on the map. Press 'Uložiť' to save all added trees.")
